...
(c) Desenvolvido por Jeff Prestes + Claudio Santiago
This work is licensed under a Creative Commons Attribution 4.0 International License.
Token: 0x71A58483781BbAC980Be8Cbf43cE9415899D204f
*/
...
contract TicketERC20 is IERC20, Ownable {
    ...
    constructor() {
        emissor = "Banco Flex";
        myName = "Empresa Combustivel Gas S/A 2024-02";
        mySymbol = "ECG-2024-02";
        _dataEmissao = block.timestamp;
        decimals = 2;
        prazoPagamento = _dataEmissao + 120 days;
        rating = "BBB+";
        emit NovoPrazoPagamento(_dataEmissao, prazoPagamento);
